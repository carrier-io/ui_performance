...
function renderCy() {
    ...
    var cy = window.cy = cytoscape({
        ...
        style: fetch('/ui_performance/static/vendor/cytoscape/cytostyle.json').then(function(res) { return res.json() }),
        elements: fetch(`/api/v1/ui_performance/charts/${getSelectedProjectId()}/${page_params.get("result_id")}?metric=${metric}`).then(function(res) { return res.json() }),
